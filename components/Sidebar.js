...
const Sidebar = () => {
	return (
		<div className='hidden sm:flex flex-col items-center xl:items-start xl:w-[340px] p-2 fixed h-full'>
			<div className='flex items-center justify-center w-14 h-14 hover_animation p-0 xl:ml-24'>
			...
			<div className='text-[#d9d9d9] flex items-center justify-center hover_animation xl:ml-auto xl:-mr-5 xl:mt-auto'>
				<img 
